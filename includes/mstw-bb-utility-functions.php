 ...
 *
 * 11. mstw_bb_get_current_post_type - get the current post type in the WordPress Admin
 *
 *----------------------------------------------------------------------------*/
...
//
if ( !function_exists( 'mstw_bb_get_current_post_type' ) ) {
	function mstw_bb_get_current_post_type( ) {
	...
	} //End: mstw_bb_get_current_post_type( )
}
